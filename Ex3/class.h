...
public:
	...
	void Inc() {ComplexNumber tmp(1,1);for(size_t i=0;i<v.size();i++){v[i]=v[i]+tmp;}}
	void Dec() {ComplexNumber tmp(2,2);for(size_t i=0;i<v.size();i++){v[i]=v[i]-tmp;}}
	...
	void CopyOnly(CComplexVector &&rhs){v=move(rhs.v);}
};
...
public:
	...
	CComplexVector1(CComplexVector1 &&rhs){v=move(rhs.v);}

	CComplexVector &operator=(const CComplexVector &rhs){if(this!=&rhs){CopyOnly(rhs);} return *this;}
	CComplexVector1 &operator=(const CComplexVector1 &rhs){if(this!=&rhs){CopyOnly(rhs);} return *this;}
	CComplexVector1 &operator=(const vector<ComplexNumber> rhs){v=rhs; return *this;}
...
public:
	...
	CComplexVector2(CComplexVector2 &&rhs){v=move(rhs.v);}

	CComplexVector &operator=(const CComplexVector &rhs){if(this!=&rhs){CopyOnly(rhs);} return *this;}
	CComplexVector2 &operator=(const CComplexVector2 &rhs){if(this!=&rhs){CopyOnly(rhs);} return *this;}
	CComplexVector2 &operator=(const vector<ComplexNumber> rhs){v=rhs; return *this;}
